  ...
  $.flexslider = function(el, options) {
    ...
    slider.init = function() {
      ...
      ///////////////////////////////////////////////////////////////////
       ...
       //////////////////////////////////////////////////////////////////
      //FlexSlider: Opaque layer
      if (slider.vars.directionNav) {
        var opacityScaffold = $('<ul class="flex-opacity-layers"><li class="left"></li><li class="right"></li></ul>');
        
        if (slider.containerExists) {
          $(slider.controlsContainer).append(opacityScaffold);
        } else {
          slider.append(opacityScaffold);
        }
      }
      //////////////////////////////////////////////////////////////////
